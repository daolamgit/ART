...
class CT():
    ...
    def load_rs(self, path = None, prefix = 'rs'):
        ...
        rs_file = self.find_rs( path = path, prefix= prefix)
    ...
    def find_rs(selfs, path = None, prefix = 'rs'):
        ...
        print( "No RS file. Check the RS name or location")
        return None
        #exit(0)
...
def write_header_cbct( ct, cbct, mid_slice, nSlices, path, output_prefix):
